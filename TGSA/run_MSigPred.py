...
import argparse
import logging
from MSigPred import *

# ----- Begin code for this module. -----

_toolName = "MSigPred"
_defOutPrefix = "MSigPred"  # Default output prefix.
...
def runAsStandalone():
    ...
    logging.getLogger("MSigPred").addHandler(logStream)
    logging.getLogger("MSigPred").setLevel(logging.INFO)
