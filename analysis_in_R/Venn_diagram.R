...
m2_7=  rownames( df[df$Mutect2=="GNS",])
...
vs_7=  rownames( df[df$VarScan2=="GNS",])
...
ss_7=  rownames( df[df$SomaticSniper=="GNS",])
...
png()
venn.diagram(c1,filename=paste0(out,"_",cname,".png"),height=250,width = 320,
             margin=0.05,fill=c(0), alpha=0.4,lwd=0.5, lty=1,resolution = 300,
             fontfamily="Helvetica",cat.fontfamily="Helvetica",
             fontface=c(rep("plain",4),"bold","bold",rep("plain",4),"bold","bold",rep("plain",3)),
             cex=c(rep(0.3,4),0.35,0.35,rep(0.3,4),0.35,0.35,rep(0.3,3)),
             cat.cex = 0.3)
dev.off()

cnames=c("SMK","UVL","APB","POL","MRD","HRD","GNS","AGE")

png()
venn.diagram(c2,filename=paste0(out,"_",cnames[2],".png"),height=250,width = 320,
             margin=0.05,fill=c(0), alpha=0.4,lwd=0.5, lty=1,resolution = 300,
             fontfamily="Helvetica",cat.fontfamily="Helvetica",
             fontface=c(rep("plain",4),"bold","bold",rep("plain",4),"bold","bold",rep("plain",3)),
             cex=c(rep(0.3,4),0.35,0.35,rep(0.3,4),0.35,0.35,rep(0.3,3)),
...
png()
venn.diagram(c3,filename=paste0(out,"_",cnames[3],".png"),height=250,width = 320,
             margin=0.05,fill=c(0), alpha=0.4,lwd=0.5, lty=1,resolution = 300,
             fontfamily="Helvetica",cat.fontfamily="Helvetica",
             fontface=c(rep("plain",4),"bold","bold",rep("plain",4),"bold","bold",rep("plain",3)),
             cex=c(rep(0.3,4),0.35,0.35,rep(0.3,4),0.35,0.35,rep(0.3,3)),
...
png()
venn.diagram(c4,filename=paste0(out,"_",cnames[4],".png"),height=250,width = 320,
             margin=0.05,fill=c(0), alpha=0.4,lwd=0.5, lty=1,resolution = 300,
             fontfamily="Helvetica",cat.fontfamily="Helvetica",
             fontface=c(rep("plain",4),"bold","bold",rep("plain",4),"bold","bold",rep("plain",3)),
             cex=c(rep(0.3,4),0.35,0.35,rep(0.3,4),0.35,0.35,rep(0.3,3)),
...
png()
venn.diagram(c5,filename=paste0(out,"_",cnames[5],".png"),height=250,width = 320,
             margin=0.05,fill=c(0), alpha=0.4,lwd=0.5, lty=1,resolution = 300,
             fontfamily="Helvetica",cat.fontfamily="Helvetica",
             fontface=c(rep("plain",4),"bold","bold",rep("plain",4),"bold","bold",rep("plain",3)),
             cex=c(rep(0.3,4),0.35,0.35,rep(0.3,4),0.35,0.35,rep(0.3,3)),
...
png()
venn.diagram(c6,filename=paste0(out,"_",cnames[6],".png"),height=250,width = 320,
             margin=0.05,fill=c(0), alpha=0.4,lwd=0.5, lty=1,resolution = 300,
             fontfamily="Helvetica",cat.fontfamily="Helvetica",
             fontface=c(rep("plain",4),"bold","bold",rep("plain",4),"bold","bold",rep("plain",3)),
             cex=c(rep(0.3,4),0.35,0.35,rep(0.3,4),0.35,0.35,rep(0.3,3)),
...
png()
venn.diagram(c7,filename=paste0(out,"_",cnames[7],".png"),height=250,width = 320,
             margin=0.05,fill=c(0), alpha=0.4,lwd=0.5, lty=1,resolution = 300,
             fontfamily="Helvetica",cat.fontfamily="Helvetica",
             fontface=c(rep("plain",4),"bold","bold",rep("plain",4),"bold","bold",rep("plain",3)),
             cex=c(rep(0.3,4),0.35,0.35,rep(0.3,4),0.35,0.35,rep(0.3,3)),
...
png()
venn.diagram(c8,filename=paste0(out,"_",cnames[8],".png"),height=250,width = 320,
             margin=0.05,fill=c(0), alpha=0.4,lwd=0.5, lty=1,resolution = 300,
             fontfamily="Helvetica",cat.fontfamily="Helvetica",
             fontface=c(rep("plain",4),"bold","bold",rep("plain",4),"bold","bold",rep("plain",3)),
             cex=c(rep(0.3,4),0.35,0.35,rep(0.3,4),0.35,0.35,rep(0.3,3)),
